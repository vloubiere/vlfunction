...
#'
#' @examples
#' vl_MAplot(DESeq2_dat= fread("/groups/stark/vloubiere/projects/epigenetic_cancer/db/FC_tables/RNA/epiCancer_GFP_PH29_vs_W29.txt"),
#'           main= "PH29")
vl_MAplot <- function(DESeq2_dat, main= NA, padj.cutoff= 0.05, log2FC.cutoff= log2(1.5))
{
  ...
  DESeq2_dat <- DESeq2_dat[order(col=="lightgrey", decreasing = TRUE)]
